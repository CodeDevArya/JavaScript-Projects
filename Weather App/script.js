...
document.querySelector("#SSubmit").addEventListener("click", (e) => {
    e.preventDefault()
    main(city.value);
    cityName.innerHTML = city.value;
})
document.querySelector("#Bengaluru-weather").addEventListener("click", (e) => {
    e.preventDefault()
    main("Bengaluru")
    cityName.innerHTML = "Bengaluru";
})
document.querySelector("#uk_weather").addEventListener("click", (e) => {
    e.preventDefault()
    main("Uttarakhand")
    cityName.innerHTML = "Uttarakhand";
})
document.querySelector("#london_weather").addEventListener("click", (e) => {
    e.preventDefault()
    main("London")
